...
- 企业用户在 60 秒内能看懂：哪些回答 ready、哪些缺证据、哪些有风险、哪些需要人审。
...
- **Fixture eval**：优先准备 1 套高质量 enterprise sample pack，至少 8 个 question item；第二套 sample pack 只在主路径稳定后作为可选扩展。
...
- 完成 primary enterprise sample pack、mock run、状态机、dashboard skeleton。
